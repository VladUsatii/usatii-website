    ...
    <section className="w-full bg-white px-6 py-24 text-left lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-8 border-t border-neutral-200 pt-8 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-4xl font-medium tracking-[-0.035em] text-neutral-950 sm:text-6xl">Selected creative work.</h2>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-600">A selection of published work produced through systems we designed and built.</p>
          </div>
